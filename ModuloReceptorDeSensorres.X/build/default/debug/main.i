...
void __attribute__((picinterrupt(("high_priority")))) VectorInterrupcion(void) {
    if (PIR2bits.EEIF == 1) {
        PIR2bits.EEIF = 0;
    }
    if (PIR1bits.RCIF == 1){
...
void main(void) {
    ...
    while(1){
        ...
        if (FinRx == 1) {
            FinRx = 0;
            Instrumento = 0;
            if ((MensajeRx[0] == 'P') && (MensajeRx[1] == 'V')) {
                Instrumento = 'V';
            }
            if ((MensajeRx[0] == 'P') && (MensajeRx[1] == 'A')) {
                Instrumento = 'A';
            }
            if ((MensajeRx[0] == 'P') && (MensajeRx[1] == 'T')) {
                Instrumento = 'T';
            }
            if ((MensajeRx[0] == 'H') && (MensajeRx[1] == 'I')) {
                Instrumento = 'H';
            }
        }
        switch (Instrumento) {
        ...
        if (Instrumento != 0) {
            ...
            while (Instrumento != 'H') {
                ...
                if (FinRx == 1) {
                    FinRx = 0;
                    if ((MensajeRx[0] == 'P') && (MensajeRx[1] == 'E')) {
                        Instrumento = 'H';
                    }
                }
            }
